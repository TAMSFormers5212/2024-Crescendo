...
Winch::Winch(int motor)
    : m_winchMotor(motor, rev::spark::SparkMax::MotorType::kBrushless),
    m_winchConfig() {
    resetMotor();
    m_winchMotor.Configure(m_winchConfig, SparkBase::ResetMode::kResetSafeParameters, SparkBase::PersistMode::kPersistParameters);
...
void Winch::resetMotor() {
    ...
    m_winchMotor.Configure(m_winchConfig, SparkBase::ResetMode::kResetSafeParameters, SparkBase::PersistMode::kPersistParameters);  // turn it to linear distance
}
