...
Winch::Winch(int motor)
    ...
    resetMotor();
    m_winchMotor.Configure(m_winchConfig, SparkMax::ResetMode::kResetSafeParameters, SparkMax::PersistMode::kPersistParameters);
...
void Winch::resetMotor() {
    ...
    m_winchMotor.Configure(m_winchConfig, SparkMax::ResetMode::kResetSafeParameters, SparkMax::PersistMode::kPersistParameters);  // turn it to linear distance
}
