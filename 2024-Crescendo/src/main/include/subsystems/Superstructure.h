...
//2 motors
   ...
   private:
    ...
    vector<double> distances = { 36, 41, 48, 60, 72, 84, 96, 111};
    vector<double> angles = { 0.218, 0.231, 0.268, 0.366, 0.433, 0.463, 0.522, 0.544};
    vector<double> speeds = { 600, 600, 600, 600, 600, 600, 600, 600};
};
