...
//2.2009 
    ...
    namespace topright{
        ...
        constexpr double offset = -0.492;//5.04/(2*M_PI);//0.534055-0.828717-0.1;//(149.056526933-120.869343735-5)/360;
        // 4.07
    }
    ...
    namespace bottomright{          
        ...
        constexpr double offset = 0;//0.311/(2*M_PI);
        //2.253189
    }
